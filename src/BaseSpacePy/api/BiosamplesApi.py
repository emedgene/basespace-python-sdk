...
class BiosamplesApi(object):
    ...
    #     This method makes a synchronous HTTP request by default. To make an
    #     asynchronous HTTP request, please pass async_req=True
    #     >>> thread = biosample_api.get_v2_biosamples_biosampleid_labrequeues(biosampleid, async_req=True)
    #     >>> result = thread.get()
    #
    #     :param async_req bool
    ...
    #     This method makes a synchronous HTTP request by default. To make an
    #     asynchronous HTTP request, please pass async_req=True
    #     >>> thread = biosample_api.get_v2_biosamples_biosampleid_labrequeues_with_http_info(biosampleid, async_req=True)
    #     >>> result = thread.get()
    #
    #     :param async_req bool
    #     :param str biosampleid: Biosample ID (required)
    ...
    #     This method makes a synchronous HTTP request by default. To make an
    #     asynchronous HTTP request, please pass async_req=True
    #     >>> thread = biosample_api.get_v2_biosamples_id(id, async_req=True)
    #     >>> result = thread.get()
    #
    #     :param async_req bool
    ...
    #     This method makes a synchronous HTTP request by default. To make an
    #     asynchronous HTTP request, please pass async_req=True
    #     >>> thread = biosample_api.get_v2_biosamples_id_with_http_info(id, async_req=True)
    #     >>> result = thread.get()
    #
    #     :param async_req bool
    #     :param str id: Biosample ID (required)
    ...
    #     This method makes a synchronous HTTP request by default. To make an
    #     asynchronous HTTP request, please pass async_req=True
    #     >>> thread = biosample_api.get_v2_biosamples_id_libraries(id, async_req=True)
    #     >>> result = thread.get()
    #
    #     :param async_req bool
    #     :param str id: Biosample ID (required)
    ...
    #     This method makes a synchronous HTTP request by default. To make an
    #     asynchronous HTTP request, please pass async_req=True
    #     >>> thread = biosample_api.get_v2_biosamples_id_libraries_with_http_info(id, async_req=True)
    #     >>> result = thread.get()
    #
    #     :param async_req bool
    #     :param str id: Biosample ID (required)
    ...
    #     This method makes a synchronous HTTP request by default. To make an
    #     asynchronous HTTP request, please pass async_req=True
    #     >>> thread = biosample_api.get_v2_biosamples_id_runlanesummaries(id, async_req=True)
    #     >>> result = thread.get()
    #
    #     :param async_req bool
    #     :param str id: Biosample ID (required)
    ...
    #     This method makes a synchronous HTTP request by default. To make an
    #     asynchronous HTTP request, please pass async_req=True
    #     >>> thread = biosample_api.get_v2_biosamples_id_runlanesummaries_with_http_info(id, async_req=True)
    #     >>> result = thread.get()
    #
    #     :param async_req bool
    #     :param str id: Biosample ID (required)
    ...
    #     This method makes a synchronous HTTP request by default. To make an
    #     asynchronous HTTP request, please pass async_req=True
    #     >>> thread = biosample_api.post_v2_biosamples_bulkupdate(async_req=True)
    #     >>> result = thread.get()
    #
    #     :param async_req bool
    ...
    #     This method makes a synchronous HTTP request by default. To make an
    #     asynchronous HTTP request, please pass async_req=True
    #     >>> thread = biosample_api.post_v2_biosamples_bulkupdate_with_http_info(async_req=True)
    #     >>> result = thread.get()
    #
    #     :param async_req bool
    #     :param V2PostBioSamplesBulkUpdateRequest payload:
    ...
    #     This method makes a synchronous HTTP request by default. To make an
    #     asynchronous HTTP request, please pass async_req=True
    #     >>> thread = biosample_api.post_v2_biosamples_id(id, async_req=True)
    #     >>> result = thread.get()
    #
    #     :param async_req bool
    #     :param str id: Biosample ID (required)
    ...
    #     This method makes a synchronous HTTP request by default. To make an
    #     asynchronous HTTP request, please pass async_req=True
    #     >>> thread = biosample_api.post_v2_biosamples_id_with_http_info(id, async_req=True)
    #     >>> result = thread.get()
    #
    #     :param async_req bool
    #     :param str id: Biosample ID (required)
